...
## 💡 P-17 — 사이클 정의 재검토 후속: 실증 편입 트랙·밴드 창 확장·공급 축 (리서치 2026-08-31)
...
1. **밴드 관측 창 소급 확장** — 현행 시세창 2020~(연 6점, 완결 사이클 0~1개)은 통계적으로
   부족(실무 하한 완결 2~3사이클, 평균회귀 반감기 ~14년). KRX/공식 소스에서 2010년대
   시세·주식수 소급 가능성 조사 → 가능 범위만 확장. (어댑터 확정 전 스텁 — 절대금지 1 준수)
