...
> ❄️ **v0.2 유산(2026-08-26 v0.3 비준 — PIVOT-1).** 이 문서의 M1~M4 마일스톤 프롬프트는
> 스윙 체제 전제라 더 이상 투입하지 않는다. v0.3 작업 단위는 설계서 §10 로드맵(Phase 0~4)이
> 기준이며, Phase별 프롬프트가 필요해지면 별도 문서로 신설한다. 역사 기록으로만 유지.
