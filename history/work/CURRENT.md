...
- **Phase 3 페이퍼 관찰 기간(1~2개월)** — 자동: eod-v3 평일 18:00(시세·재무·수급·공매도/대차/
  ...
  웹: 포트 80(운영자 도메인/테일넷 IP — 대시보드·종목·산업·보고서·자료실, P-15/P-16 완결).
- 관찰 포인트: 수급 60일 창 도달 시 네거티브 스크린 배선 제안 · 후보 품질·탈락 분포 주간
  리뷰 · **policy-v1.5 첫 자동 주기(9/5 토) 산출 확인** · 건설기계(큐) 사양 ⚠ 재관찰.
- **운영자 결재 대기**: **P-18(우선순위 반전 — 가치 코어 게이트·사이클은 도구, 방향 승인
  2026-08-31) 세부 ①과열 처리 ②유니버스 범위 ③가치 기준** — 결재 후 구현 착수.
  P-18 하에서 재해석·존속: P-17 B(계측 전용 트랙)·C(승격 규칙). 반도체 순수화+
  MIN_COMPOSITION 완화는 P-18 구현 시 자연 흡수(화이트리스트 격하).
