...
## 진행 중
- **실투자 병행 개시(2026-09-02)** — 승인 5종 각 100주: 원림 15,350 · 에이스침대 33,000 ·
  아이퀘스트 2,720 · 신세계I&C 13,090 · 대한약품 26,950(개시 평균 +1.03%). 가이드 = `/paper`
  "매매 가이드"(policy v2.8~v2.10: 5단 매도 80·90·100·120·150% 각 20주 · 매수 상한
  min(목표가 1/3 지점, 첫 매도선) · 이익 보호(90%+ 터치 후 직전 선 이탈) · 사이클 재등록 중립).
  실매수 추가 시 rebase/체결 반영은 세션에 지시.
