...
- **P-20 ④ 완료(9/4 14:50, policy v2.19 데이터 기준 개정)**: 연간 전체 재무제표 1콜 백필(지배주주지분·귀속 순이익·접수번호 →
  ...
  파생 0. **발견 → A-0 결재(P-20 ⑧)**: 캡 ROE 기준 혼합. pytest 715·mypy 217. 웹 재기동. 상세 →
  [archive](archive/2026-09-04-p20-4-owner-equity-backfill.md).
...
0. **🆕 P-20 ⑧ 정당 PBR 캡의 ROE 기준(v2.19 구현 중 발견, 9/4 오후)** — 밴드 PBR은 지배주주 기준으로 승격됐는데 캡 ROE₅는 연결 기준.
   권고 **(b) 승격 종목은 캡 ROE도 지배주주 기준**(귀속 순이익÷지배주주지분 5y 중앙). 효과: 경계 교차 4종, 승인 종목 성우하이텍 +44→+23%
   승인 보류 파생. 대안 (c) 밴드 승격 보류. 상세 → PROPOSALS P-20 ⑧.
