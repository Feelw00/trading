...
**M4 / 운영 진입** (다음 후보)
1. cron 일괄 enable (운영자 결정 — R0~R7 슬롯 준비 완료, Telegram 알림 가동)
2. 이벤트 감시기(`watch/`) → P0 발화 (서킷브레이커·환율 임계·바이너리 전이·보유 공시)
3. 리플레이 회귀 테스트 (6/2~6/8 주간, M4 프롬프트)
4. 승인 전이(draft→approved) 운영자 도구
