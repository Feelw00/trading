...
- 관찰 포인트: **P-18 첫 자동 주기(9/5 토) 산출 확인**(가치 후보 546·과열 ⚠ 235 기준선) ·
  후보 품질·탈락 분포 주간 리뷰 · 수급 60일 창 도달 시 네거티브 스크린 배선 제안 ·
  건설기계(큐) 사양 ⚠ 재관찰 · 태깅 스킵 130 일간 재시도 소진 확인.
- **운영자 결재 후보(신규, P-18 후속)**: ① **지주 디스카운트 아티팩트**(연결자본 PBR로
  지주가 시장 최저 상시 점유 — KG케미칼 0.07배 등) 처리 방침 ② **관리종목·감사의견 필터
  (PIVOT-3)** 우선순위 상향(전 상장 확장으로 노출 증가) ③ R5 사이징의 사이클 가중 계수(§6).
