...
def build_prompt(
    ...
    return (
        ...
        '    "targets": [{"level": <익절 레벨 — 저항·전고 기반>, "pct": <원 포지션 %>}],  // 선택, 오름차순 1~2개·합≤100\n'
        ...
        "targets는 레벨 오름차순·pct 합≤100. soft_stop.level 은 반드시 stop_level 위(경고→축소, 하드→전량). "
        "불확실하면 생략하라(생략 시 코드가 보수 기본값으로 청산 관리).\n"
